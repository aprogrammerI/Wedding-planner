...
//
//   // onDueDateChange() {
//   //   if (this.newDueDate && !this.newReminderDate) {
//   //     this.newReminderDate = this.newDueDate;
//   //     this.newReminderEnabled = true;
//   //   }
//   // }
//
//   onDueDateChange() {
//     this.newReminderEnabled = !!this.newDueDate;
//   }
//
...
//
//   onReminderEnabledChange() {
//     if (this.newReminderEnabled && !this.newDueDate) {
...
//   //   if (!this.newTitle.trim()) return;
//   //
//   //   const reminderDate = this.newReminderDate || this.newDueDate || undefined;
//   //   const reminderEnabled = !!(this.newReminderEnabled || this.newDueDate || this.newReminderDate);
//   //
//   //   this.svc.add({
//   //     title: this.newTitle,
//   //     done: false,
...
//   //       this.load();
//   //     },
//   //     error: (e) => { console.error('Error adding task:', e); alert('Failed to add task. Please try again.'); }
//   //   });
//   // }
//
//
...
//     if (!this.newTitle.trim()) return;
//
//     const due = this.newDueDate || undefined;
//     const reminderEnabled = !!(this.newReminderEnabled && due);
//
//     this.svc.add({
//       title: this.newTitle,
//       done: false,
//       description: this.newDescription || undefined,
//       dueDate: due,                              // SAME DATE
//       priority: this.newPriority,
//       assignedTo: this.newAssignedTo || undefined,
//       reminderDate: reminderEnabled ? due : undefined,  // SAME DATE
//       reminderEnabled
//     }).subscribe({
//       next: () => {
//         this.newTitle = '';
...
//       next: () => this.loadOverdueReminders(),    //this.loadReminders(),
//       error: (error) => {
...
//     this.editDraft = {
//       ...task,
//       // show the one date in the editor from dueDate; enable checkbox if date present
//       dueDate: task.dueDate,
//       reminderEnabled: !!(task.dueDate || task.reminderEnabled)
//     };
//   }
//
//   cancelEdit() {
...
//   saveEdit() {
//     if (this.editingTaskId == null) return;
//     const due = (this.editDraft.dueDate as string) || undefined;
//     const reminderEnabled = !!this.editDraft.reminderEnabled && !!due;
//
//     const updated: Task = {
//       id: this.editingTaskId,
//       title: (this.editDraft.title || '').trim(),
...
//       error: (e) => { console.error('Error updating task:', e); alert('Failed to update task. Please try again.'); }
//     });
//   }
//
//   toggleAddForm() {
...
//
//   // getReminderStatus(task: Task): string {
//   //   const dateStr = task.dueDate || task.reminderDate;
//   //   if (!dateStr) return '';
//   //
//   //   const d = new Date(dateStr);
//   //   const today = new Date();
//   //   // normalize to dates (ignore time-of-day)
//   //   d.setHours(0, 0, 0, 0);
...
//
// //
// // // frontend/Wedding-planner-frontend/src/app/pages/task-manager/task-manager.ts
// // import { Component, OnInit } from '@angular/core';
// // import { CommonModule } from '@angular/common';
// // import { FormsModule } from '@angular/forms';
// // import { MatIconModule } from '@angular/material/icon';
...
// //   newTitle = '';
// //   newDescription = '';
// //   newDueDate = '';                         // single date field
// //   newPriority: Task['priority'] = 'medium';
// //   newAssignedTo = '';
// //   newReminderEnabled = false;              // checkbox for reminders
// //
// //   editingTaskId: number | null = null;
// //   editDraft: Partial<Task> = {};
// //   showAddForm = false;
...
// //
// //   loadAvailableUsers() {
// //     this.availableUsers = ['Bride', 'Groom', 'Wedding Planner', 'Other'];
// //   }
// //
// //   loadOverdueReminders() {
// //     this.svc.getOverdueReminders().subscribe(reminders => {
...
// //     this.editDraft = {
// //       ...task,
// //       dueDate: task.dueDate,                               // show single date
// //       reminderEnabled: !!(task.dueDate || task.reminderEnabled)
// //     };
// //   }
// //
...
// //
// //   sortByPriority() {
// //     const rank: Record<NonNullable<Task['priority']>, number> = { high: 0, medium: 1, low: 2 };
// //     this.tasks = [...this.tasks].sort((a, b) => {
// //       const ra = rank[(a.priority || 'medium') as NonNullable<Task['priority']>];
// //       const rb = rank[(b.priority || 'medium') as NonNullable<Task['priority']>];
// //       if (ra !== rb) return ra - rb;
...
export class TaskManager implements OnInit {
  ...
  add() {
    ...
    // Use the reminder date as the single source of truth
    const due = this.newReminderDate || undefined;
    const reminderEnabled = !!(this.newReminderEnabled && due);
    ...
    this.svc.add({
      ...
      priority: this.newPriority,
      assignedTo: this.newAssignedTo || undefined,
      reminderDate: due,                         // set
      reminderEnabled                            // follows checkbox + has date
    }).subscribe({
      next: () => {
        this.newTitle = '';
        this.newDescription = '';
